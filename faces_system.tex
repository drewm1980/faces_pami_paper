...
\centering
\begin{tabular}{@{}c@{}c@{}}
\includegraphics[height=1.35in]{figures_cvpr/illum_results/coverage_sunset.pdf} &
\includegraphics[height=1.35in]{figures_cvpr/illum_results/granularity_sunset.pdf} \\
...
\begin{figure}
\centerline{
\includegraphics[width=3in]{figures_pami/occ_block.png}\vspace{0mm}}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bios/arvind}}]{John Wright}
