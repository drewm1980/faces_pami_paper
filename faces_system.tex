...
approaches, we refer the interested reader to \cite{YangA2010-pp} 
On a Mac Pro with
...
\biospace
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bios/zihan}}]{Zihan Zhou}
received the bachelor's degree in automation from Tsinghua
...
{bios/hossein}}]{Hossein Mobahi} is currently a PhD
