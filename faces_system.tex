...
\renewcommand{\tempwidth}[0]{1.85in}
\begin{figure}[t]
\vspace{.2in}
\centerline{
	\begin{tabular}{@{}c@{}c@{}}
	\includegraphics[trim=.9in 0in 1.2in 0in, clip, width=\tempwidth]{figures_pami/pami_roc_revision2} &
	\includegraphics[trim=.9in 0in 1.2in 0in, clip, width=\tempwidth]{figures_pami/pami_roc2} \\
	{\small (a)} & {\small (b)} \\
	\end{tabular}
}
